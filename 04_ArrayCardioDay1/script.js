...
const sortByYearsLived = inventors.sort(function(a,b){
  const ylivedByA = a.passed-a.year;
  const ylivedByB = b.passed-b.year;
  return ylivedByA < ylivedByB ? 1 : -1;
});
*/
...
/* const category = document.querySelector('.mw-category');
 // This is called a spread. The inner content is a NodeList. With a Spread,
 // I take all the elements of that list and in above the array
